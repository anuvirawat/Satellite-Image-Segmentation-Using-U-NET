...
def get_masks_list():
    ...
    files_train_temp = os.listdir(os.path.join(inDir,"Data_masks/Bldg"))
    files_train_final = []
    ...
    files_test_temp = os.listdir( os.path.join(inDir,"Data_masks/Bldg/Test") )
    files_test_final = []
...
def get_testing_image_pair(files_test,imageId):
    ...
    path = os.path.join(os.getcwd(),"Data_masks/Bldg/Test/" + imageId + "_Bldg.tif")
...
def initialize_parameters():
    ...
    left_1_1_conv = tf.get_variable(name = "Bldg_left_1_1_conv",shape = (3,3,9,32),dtype = tf.float32)
    left_1_1_conv_bias = tf.get_variable(name = "Bldg_left_1_1_conv_bias",shape = (32),dtype = tf.float32)
    
    left_1_2_conv = tf.get_variable(name = "Bldg_left_1_2_conv",shape = (3,3,32,32),dtype = tf.float32)
    left_1_2_conv_bias = tf.get_variable(name = "Bldg_left_1_2_conv_bias",shape = (32),dtype = tf.float32)

    left_2_1_conv = tf.get_variable(name = "Bldg_left_2_1_conv",shape = (3,3,32,64),dtype = tf.float32)
    left_2_1_conv_bias = tf.get_variable(name = "Bldg_left_2_1_conv_bias",shape = (64),dtype = tf.float32)
    
    left_2_2_conv = tf.get_variable(name = "Bldg_left_2_2_conv",shape = (3,3,64,64),dtype = tf.float32)
    left_2_2_conv_bias = tf.get_variable(name = "Bldg_left_2_2_conv_bias",shape = (64),dtype = tf.float32)    
    
    left_3_1_conv = tf.get_variable(name = "Bldg_left_3_1_conv",shape = (3,3,64,128),dtype = tf.float32)
    left_3_1_conv_bias = tf.get_variable(name = "Bldg_left_3_1_conv_bias",shape = (128),dtype = tf.float32)

    left_3_2_conv = tf.get_variable(name = "Bldg_left_3_2_conv",shape = (3,3,128,128),dtype = tf.float32)
    left_3_2_conv_bias = tf.get_variable(name = "Bldg_left_3_2_conv_bias",shape = (128),dtype = tf.float32)
    
    left_4_1_conv = tf.get_variable(name = "Bldg_left_4_1_conv",shape = (3,3,128,256),dtype = tf.float32)
    left_4_1_conv_bias = tf.get_variable(name = "Bldg_left_4_1_conv_bias",shape = (256),dtype = tf.float32)    
    
    left_4_2_conv = tf.get_variable(name = "Bldg_left_4_2_conv",shape = (3,3,256,256),dtype = tf.float32)
    left_4_2_conv_bias = tf.get_variable(name = "Bldg_left_4_2_conv_bias",shape = (256),dtype = tf.float32)        
    
    centre_5_1_conv = tf.get_variable(name = "Bldg_centre_5_1_conv",shape = (3,3,256,512),dtype = tf.float32)
    centre_5_1_conv_bias = tf.get_variable(name = "Bldg_centre_5_1_conv_bias",shape = (512),dtype = tf.float32)    
    
    centre_5_2_conv = tf.get_variable(name = "Bldg_centre_5_2_conv",shape = (3,3,512,512),dtype = tf.float32)
    centre_5_2_conv_bias = tf.get_variable(name = "Bldg_centre_5_2_conv_bias",shape = (512),dtype = tf.float32)

    centre_5_3_deconv = tf.get_variable(name = "Bldg_centre_5_3_deconv",shape = (2,2,128,512),dtype = tf.float32)         

    right_4_1_conv = tf.get_variable(name = "Bldg_right_4_1_conv",shape = (3,3,128 + 256,256),dtype = tf.float32)
    right_4_1_conv_bias = tf.get_variable(name = "Bldg_right_4_1_conv_bias",shape = (256),dtype = tf.float32)
    
    right_4_2_conv = tf.get_variable(name = "Bldg_right_4_2_conv",shape = (3,3,256,256),dtype = tf.float32)
    right_4_2_conv_bias = tf.get_variable(name = "Bldg_right_4_2_conv_bias",shape = (256),dtype = tf.float32)

    right_4_3_deconv = tf.get_variable(name = "Bldg_right_4_3_deconv",shape = (2,2,256,256),dtype = tf.float32)         
    
    right_3_1_conv = tf.get_variable(name = "Bldg_right_3_1_conv",shape = (3,3,128 + 256,128),dtype = tf.float32)
    right_3_1_conv_bias = tf.get_variable(name = "Bldg_right_3_1_conv_bias",shape = (128),dtype = tf.float32)
    
    right_3_2_conv = tf.get_variable(name = "Bldg_right_3_2_conv",shape = (3,3,128,128),dtype = tf.float32)
    right_3_2_conv_bias = tf.get_variable(name = "Bldg_right_3_2_conv_bias",shape = (128),dtype = tf.float32)

    right_3_3_deconv = tf.get_variable(name  = "Bldg_right_3_3_deconv", shape = (2,2,128,128),dtype = tf.float32)

    right_2_1_conv = tf.get_variable(name = "Bldg_right_2_1_conv",shape = (3,3,128 + 64,64),dtype = tf.float32)
    right_2_1_conv_bias = tf.get_variable(name = "Bldg_right_2_1_conv_bias",shape = (64),dtype = tf.float32)
    
    right_2_2_conv = tf.get_variable(name = "Bldg_right_2_2_conv",shape = (3,3,64,64),dtype = tf.float32)
    right_2_2_conv_bias = tf.get_variable(name = "Bldg_right_2_2_conv_bias",shape = (64),dtype = tf.float32)
    
    right_2_3_deconv = tf.get_variable(name = "Bldg_right_2_3_deconv",shape = (2,2,64,64),dtype = tf.float32)

    right_1_1_conv = tf.get_variable(name = "Bldg_right_1_1_conv",shape = (9,9,64+32,32),dtype = tf.float32)
    right_1_1_conv_bias = tf.get_variable(name = "Bldg_right_1_1_conv_bias",shape = (32),dtype = tf.float32)
    
    right_1_2_conv = tf.get_variable(name = "Bldg_right_1_2_conv",shape = (9,9,32,1),dtype = tf.float32)
    right_1_2_conv_bias = tf.get_variable(name = "Bldg_right_1_2_conv_bias",shape = (1),dtype = tf.float32)
...
def model(image_test,truth,img_rows,img_cols,num_channels):
    ...
    with tf.Session() as sess:
        ...
        path = os.path.join(os.getcwd(),"Parameters/Bldg")
        ckpt = tf.train.get_checkpoint_state(path)
            
        if ckpt and ckpt.model_checkpoint_path:
            print("Restoration of parameters of model with code_string Bldg has been successfull")
...
if __name__ == '__main__':
    ...
    writer_1 = gdal_utils()
    writer_1.create_tiff_file_from_array(os.path.join(os.getcwd(),"Data_masks/Bldg/Test/" + files_test[1] + "_Bldg.tif"),os.path.join(os.getcwd(),"Results/Bldg.tif"),answer)    
    ...
    writer_2 = gdal_utils()
    writer_2.create_tiff_file_from_array(os.path.join(os.getcwd(),"Data_masks/Bldg/Test/" + files_test[1] + "_Bldg.tif"),os.path.join(os.getcwd(),"Results/processed_pred_Bldg.tif"),re)        
